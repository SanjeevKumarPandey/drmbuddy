...
function externalURLHandler(url, widget_id, id, index) {
...
function setUrl() {
    externalURLHandler("http://access.adobeprimetime.com/flashaccessserver/axs_prod/flashaccess/license/v6", "license_svr", "License", 0);
    externalURLHandler("http://individualization.adobe.com/flashaccess/i15n/v5", "indiv_svr", "Indiv", 1);
    externalURLHandler("http://crl2.adobe.com/Adobe/FlashAccessIndividualizationCA.crl", "crl_svr", "CRL", 2);
    //statuses.join('|');
    console.log("this"+JSON.stringify(statuses));
    setCookies();
}
